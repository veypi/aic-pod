...
func TestExecutionDedupAndRetention(t *testing.T) {
	m := NewManager(time.Minute)
	var calls atomic.Int32
	o := CallOptions{ID: "once", Owner: "owner", Digest: "same", Command: "fixture wait", LogPath: filepath.Join(t.TempDir(), "out.log"), Run: func(context.Context, io.Writer) (any, error) { calls.Add(1); return map[string]int{"answer": 42}, nil }}
	...
	if _, err = os.Stat(o.LogPath); err == nil {
		t.Fatal("default log retained past TTL")
	}
